...
/// @title  CompoundBeacon
/// @notice Creates new compound strategies.
contract CompoundStrategyFactory is UpgradeableBeacon, IBaseContract {
    ...
    function getName() override external view returns (bytes32) {
        return "CompoundStrategyFactory";
    }
