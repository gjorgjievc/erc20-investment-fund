...
/// @notice Creates new manager strategies.
contract StrategyManagerFactory is UpgradeableBeacon, IBaseContract {

    /// @notice address of compound strategies per underlying token
    mapping(address => address) public strategyManagers;
    ...
    external onlyOwner returns (address) {
        ...
        // init the strategy
        StrategyManager(instance).initialize(_underlying, _registry, msg.sender, _data);

        strategyManagers[_underlying] = instance;
